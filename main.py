...
def main():
    ...
    print "Team Reroll?\tDodge\tSure Hands\tSure Feet\tLoner\tPro\tTwo Heads\tExtra Arms\tPrehensize Tail (defender)\tBlizzard\tAgi\tBreak Tackle Strength"
                                        ...
                                        for prehensile_tail in [True, False]:
                                            for blizzard in [True, False]:
                                                for break_tackle in xrange(0, 7):
                                                    ...
                                                    ystrings = map(lambda x: "Y" if x else "N", [trr, dodge, sure_hands, sure_feet, loner, pro, two_heads, extra_arms, prehensile_tail, blizzard])
